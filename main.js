...
let texCoordCenter = [0.5, 0.5];
let texCoordScale = 0.7;
let texCoordRotation = 0.0;
...
function ShaderProgram(name, program) {
    ...
    this.iTexCoordCenter = -1;
    this.iTexCoordScale = -1;
    this.iTexCoordRotation = -1;
...
async function initGL() {
    ...
    shProgram.iTexCoordCenter = gl.getUniformLocation(prog, "uTexCoordCenter");
    shProgram.iTexCoordScale = gl.getUniformLocation(prog, "uTexCoordScale");
    shProgram.iTexCoordRotation = gl.getUniformLocation(prog, "uTexCoordRotation");
